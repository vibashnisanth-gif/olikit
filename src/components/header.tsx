      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-md p-3 text-text-secondary hover:bg-surface-muted hover:text-text-primary"
            aria-label="Search"
          >
            ...
            <div className="flex flex-col gap-1 px-4 py-3">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="rounded-md px-3 py-2 text-sm font-medium text-text-secondary hover:bg-surface-muted"
