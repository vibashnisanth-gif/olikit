...
interface CostOfLivingComparisonSectionProps {
  title?: string
...
export function CostOfLivingComparisonSection({ title = "Cost of Living Comparison", countryA, countryB, rows }: CostOfLivingComparisonSectionProps) {
  return (
