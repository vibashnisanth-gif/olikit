      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
              ...
              {countries.map((c) => (
                <li key={c.slug}>
                  ...
                  {stateCountrySlugs.includes(c.slug) && (
                    <a href={`/${c.slug}/states`} className="ml-7 block text-[10px] text-zinc-600 hover:text-zinc-800 transition-colors">
                      States & regions →
                    </a>
                  )}
                </li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm text-zinc-700">
              <li><a href="/about" className="transition-colors hover:text-zinc-950">About</a></li>
              <li><a href="/contact" className="transition-colors hover:text-zinc-950">Contact</a></li>
              <li><a href="/privacy-policy" className="transition-colors hover:text-zinc-950">Privacy Policy</a></li>
              <li><a href="/terms" className="transition-colors hover:text-zinc-950">Terms of Use</a></li>
            </ul>
          </div>
        </div>
