    ...
    <footer className="mt-auto border-t border-zinc-200 bg-zinc-50">
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500">Countries</h3>
              ...
              {countries.map((c) => (
                <li key={c.slug}>
                  ...
                  {stateCountrySlugs.includes(c.slug) && (
                    <a href={`/${c.slug}/states`} className="ml-7 block text-[10px] text-zinc-500 hover:text-zinc-700 transition-colors">
                      States & regions →
                    </a>
                  )}
                </li>
          ...
          <div>
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500">Research</h3>
          ...
          <div>
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500">Trust</h3>
            <ul className="space-y-1.5 text-sm text-zinc-500">
          ...
          <div>
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500">Company</h3>
            <ul className="space-y-1.5 text-sm text-zinc-500">
