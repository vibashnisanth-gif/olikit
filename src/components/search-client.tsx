...
export const SearchClient = memo(function SearchClient({localeSlug}: Props) {
  ...
  const allResults: SearchResult[] = useMemo(() => {
    ...
    results.push({
      label: "Salary Hub",
      description: "Salary calculators, guides, and state-by-state salary data",
      href: `/${localeSlug}/salary`,
      category: "Salary",
    });
    results.push({
      label: "Financial Data Library",
      description: "Verified financial data from official government sources",
      href: `/${localeSlug}/financial-data`,
      category: "Data",
    });
    results.push({
      label: "State Rankings",
      description: "Best states for salary, cost of living, retirement, and home affordability",
      href: `/${localeSlug}/best-states-for-salary`,
      category: "Rankings",
    });
    results.push({
      label: "Latest Updates",
      description: "Recent changes to data, tools, and content",
      href: `/${localeSlug}/updates`,
      category: "Site",
    });
  ...
  return (
    <div>
      <div className="relative mb-8">
        ...
        />
        <svg
          className="pointer-events-none absolute left-3 top-3.5 h-4 w-4 text-zinc-400"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
      ...
      {!query.trim() && (
        <p className="text-center text-sm text-zinc-500 py-10">
          Start typing to search calculators, guides, salary data, glossary terms, and more.
        </p>
      )}
