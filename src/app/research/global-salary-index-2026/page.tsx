...
export default function GlobalSalaryIndexPage() {
  ...
  const itemListSchema = {
    ...
    "@type": "ItemList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "United States", url: `${SITE_URL}/us/salary/software-engineer` },
      ...
      { "@type": "ListItem", position: 4, name: "Singapore", url: `${SITE_URL}/sg/salary/product-manager` },
      { "@type": "ListItem", position: 5, name: "Poland", url: `${SITE_URL}/research/global-salary-index-2026#country-poland` },
      { "@type": "ListItem", position: 6, name: "India", url: `${SITE_URL}/in/salary/software-engineer` },
      { "@type": "ListItem", position: 7, name: "Canada", url: `${SITE_URL}/ca/salary/data-scientist` },
      { "@type": "ListItem", position: 8, name: "Australia", url: `${SITE_URL}/au/salary/data-scientist` },
  ...
  const contentData: SalaryIndexContent = {
    ...
    relatedPages: [
      ...
      { label: "Highest Paying Countries (PM)", href: "/us/salary/product-manager" },
