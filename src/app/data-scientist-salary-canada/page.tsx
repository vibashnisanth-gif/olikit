...
export const metadata: Metadata = {
  title: "Data Scientist Salary in Canada (2026)",
  description: "Research data scientist salaries in Canada. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/data-scientist-salary-canada` },
  openGraph: { title: "Data Scientist Salary in Canada", description: "Research data scientist salaries in Canada." },
}

export default function DataScientistCA() {
  const articleSchema = buildArticleJsonLd(
    "Data Scientist Salary in Canada (2026)",
    "Research data scientist salaries in Canada. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Data Scientist Salary Canada", url: `${SITE_URL}/data-scientist-salary-canada` },
  ])
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a href="/ca/salary/data-scientist" className="rounded-md bg-zinc-100 px-5 py-2.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200">Full Salary Page</a>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Strong Immigration Pathways</h3><p className="text-sm leading-6 text-zinc-600">Canada's technology talent visa programs make it an attractive destination for skilled data scientists.</p></div>
          </div>
        </section>

        <section className="rounded-lg border border-zinc-200 bg-zinc-50 px-5 py-6 shadow-sm sm:px-8">
          <h2 className="mb-4 text-2xl font-semibold text-zinc-950">Canada Data Scientist Salary Landscape</h2>
          <p className="mb-3 text-sm leading-7 text-zinc-600">Data science demand continues to grow across Canada, driven by technology companies, financial institutions and enterprise organizations.</p>
          <p className="mb-3 text-sm leading-7 text-zinc-600">The technology workforce is expanding rapidly, with strong demand for experienced data scientists in machine learning, artificial intelligence and analytics.</p>
          <p className="mb-3 text-sm leading-7 text-zinc-600">When evaluating compensation, professionals should consider salary alongside provincial taxes, housing costs and purchasing power differences between cities.</p>
        </section>
        ...
        <section className="rounded-lg border border-zinc-200 bg-white px-5 py-6 shadow-sm sm:px-8">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <a href="/ca/salary/data-scientist" className="rounded-md bg-zinc-100 px-3 py-1.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200">Full Salary Page</a>
