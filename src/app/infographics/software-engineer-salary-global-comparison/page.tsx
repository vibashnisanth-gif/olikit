  ...
  return (
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        <section className="text-sm text-gray-500">
          <p>
            <strong>Methodology:</strong> Salary data from BLS, ONS, ABS, Statistics Canada, Stats
            NZ. Tax rates from OECD. Cost of living from Numbeo. All figures in USD equivalent. June
            2026.
          </p>
        </section>
      </div>
