  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <nav className="mb-6 text-sm text-gray-500">
        ...
        <Link href="/infographics" className="hover:text-blue-700">
          Infographics
        </Link>
        <span className="mx-2">/</span>
              ...
              <tr key={r.country} className={`border-b ${i < 3 ? "bg-blue-50" : ""}`}>
                ...
                <td className="py-3 pr-4">
                  <span className="mr-2 text-lg">
                    <FlagImage name={r.country} size="lg" />
                  </span>
      ...
      <section className="mb-12 border-t pt-8">
        ...
        <p className="mb-4 text-sm text-gray-600">
          ...
          efficiency (25%), cost of living (20%), quality of life (15%), and job market size (10%).
          Salary data sourced from Glassdoor, Levels.fyi, and local statistical agencies. Cost of
          living from Numbeo. Tax rates from government sources.
        </p>
