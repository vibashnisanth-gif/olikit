...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇺🇸", name: "United States", slug: "us", salary: "$105,300 (22% tax)" },
        { rank: 2, flag: "🇦🇺", name: "Australia", slug: "au", salary: "A$93,750 (25% tax)" },
        { rank: 3, flag: "🇸🇬", name: "Singapore", slug: "sg", salary: "S$79,050 (7% tax)" },
        { rank: 4, flag: "🇨🇦", name: "Canada", slug: "ca", salary: "C$71,250 (25% tax)" },
        { rank: 5, flag: "🇳🇿", name: "New Zealand", slug: "nz", salary: "NZ$78,750 (25% tax)" },
        { rank: 6, flag: "🇬🇧", name: "United Kingdom", slug: "uk", salary: "£49,600 (20% tax)" },
        { rank: 7, flag: "🇮🇳", name: "India", slug: "in", salary: "₹14.4L (20% tax)" },
      ],
    },
    faqs: [
