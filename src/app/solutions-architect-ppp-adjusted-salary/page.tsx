...
const pagePath = "/solutions-architect-ppp-adjusted-salary"
...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    hero: {
      badge: "PPP Analysis",
      title: "Solutions Architect PPP-Adjusted Salary",
      description: "Compare solutions architect salaries adjusted for purchasing power parity across 7 major economies. Understand the real value of compensation when adjusted for local cost of living.",
      cta: { label: "Tax-Adjusted Salary", href: "/solutions-architect-tax-adjusted-salary" },
    },
    salaryCards: [
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇮🇳", name: "India", slug: "in", salary: "₹22.0L", note: "" },
        { rank: 2, flag: "🇦🇺", name: "Australia", slug: "au", salary: "A$135,000", note: "" },
        { rank: 3, flag: "🇺🇸", name: "United States", slug: "us", salary: "$140,000", note: "" },
        { rank: 4, flag: "🇨🇦", name: "Canada", slug: "ca", salary: "C$105,000", note: "" },
        { rank: 5, flag: "🇳🇿", name: "New Zealand", slug: "nz", salary: "NZ$115,000", note: "" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", slug: "sg", salary: "S$90,000", note: "" },
        { rank: 7, flag: "🇬🇧", name: "United Kingdom", slug: "uk", salary: "£65,000", note: "" },
      ],
    },
    faqs: [
