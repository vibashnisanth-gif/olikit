...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇺🇸", name: "United States", slug: "us", salary: "$70,000", note: "Highest BA salaries" },
        { rank: 2, flag: "🇦🇺", name: "Australia", slug: "au", salary: "A$75,000", note: "Competitive BA pay" },
        { rank: 3, flag: "🇨🇦", name: "Canada", slug: "ca", salary: "C$58,000", note: "Growing BA demand" },
        { rank: 4, flag: "🇳🇿", name: "New Zealand", slug: "nz", salary: "NZ$58,000", note: "Smaller BA market" },
        { rank: 5, flag: "🇬🇧", name: "United Kingdom", slug: "uk", salary: "£38,000", note: "Strong consulting sector" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", slug: "sg", salary: "S$48,000", note: "Regional consulting hub" },
        { rank: 7, flag: "🇮🇳", name: "India", slug: "in", salary: "₹5.5L", note: "Large BA workforce" },
      ],
    },
    faqs: [
