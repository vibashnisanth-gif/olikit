...
const SALARY = { average: 38000, entryLevel: 24000, experienced: 60000 }

export const metadata: Metadata = {
  title: "Business Analyst Salary in the United Kingdom (2026)",
  description: "Research business analyst salaries in the United Kingdom. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/business-analyst-salary-uk` },
  openGraph: {
    title: "Business Analyst Salary in the United Kingdom",
    description: "Research business analyst salaries in the United Kingdom.",
  },
}

export default function business_analystSalaryUK() {
  const articleSchema = buildArticleJsonLd(
    "Business Analyst Salary in the United Kingdom (2026)",
    "Research business analyst salaries in the United Kingdom.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Business Analyst Salary United Kingdom", url: `${SITE_URL}/business-analyst-salary-uk` },
  ])
    ...
    <Shell>
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <h1 className="max-w-4xl text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">Business Analyst Salary in the United Kingdom</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">The United Kingdom offers competitive salaries for business analysts across various industries and experience levels.</p>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Competitive Salaries</h3><p className="text-sm leading-6 text-zinc-700">The average business analyst salary in the United Kingdom is {COUNTRY.currency}{SALARY.average.toLocaleString("en-US")}.</p></div>
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Career Growth</h3><p className="text-sm leading-6 text-zinc-700">Career prospects for business analysts in the United Kingdom remain strong with growing demand.</p></div>
          </div>
        </section>
        ...
        <section className="rounded-lg border border-zinc-200 bg-white px-5 py-6 shadow-sm sm:px-8">
          ...
          <div className="flex flex-wrap gap-2">
            <a href="/business-analyst" className="rounded-md bg-zinc-100 px-3 py-1.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200">Business Analyst Hub</a>
            <a href="/business-analyst-salary" className="rounded-md bg-zinc-100 px-3 py-1.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200">Salary Overview</a>
