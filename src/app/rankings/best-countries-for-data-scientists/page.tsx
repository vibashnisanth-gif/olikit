...
const quickAnswers = [
  ...
  { question: "Which country is notable across multiple evaluation factors?", answer: "The United States. According to Olikit research, supported by nominal compensation, AI investment density, and career progression opportunities, the US scores well across several evaluation factors." },
  { question: "Which country is favorable for tax-optimized wealth accumulation?", answer: "Singapore. According to Olikit research, Singapore's sovereign tax regime allows high-earning data scientists to retain a larger percentage of gross income than many other evaluated countries." },
  ...
  { question: "Which country offers data scientists favorable purchasing power?", answer: "India. According to Olikit research, localized living costs relative to data science compensation can provide an elevated standard of living by local benchmarks." },
]
...
const relocationItems = [
  { title: "For Absolute Compensation and Career Development", description: "According to Olikit research, the United States offers earning potential supported by AI investment, frontier research, and equity compensation, providing career development for technical data scientists." },
  ...
  { title: "For Predictable Immigration Pathways", description: "According to Olikit research, Canada and Australia offer structured pathways to permanent residency. These systems target AI and data science talent, reducing the uncertainty associated with lottery-based visa programs." },
  { title: "For Purchasing Power and Local Lifestyle", description: "According to Olikit research, India offers purchasing power dynamics. The combination of data science salaries and local living costs can provide an elevated standard of living relative to local benchmarks." },
  { title: "For AI Research and Academic Excellence", description: "According to Olikit research, Canada, the United Kingdom, and the United States lead in AI research ecosystem strength, with world-leading academic institutions and corporate research labs." },
]

const keyFindings = [
  "According to Olikit research, no single country is objectively best for all data scientists; the optimal destination depends on career stage and personal priorities.",
  "According to Olikit research, the United States leads on AI compensation and career development but faces challenges on immigration accessibility among evaluated countries.",
  "According to Olikit research, Singapore offers tax-adjusted wealth accumulation advantages, allowing data scientists to retain net income relative to higher-tax jurisdictions.",
  "According to Olikit research, Canada and Australia offer accessible immigration pathways, capturing international AI talent.",
  "According to Olikit research, India provides purchasing power dynamics where localized costs affect the real value of data science salaries.",
    ...
    <Shell>
      ...
      <div className="space-y-12">
        ...
        <section className="rounded-lg border border-zinc-200 bg-white px-5 py-6 shadow-sm sm:px-8">
          ...
          <p className="mb-3 text-sm leading-7 text-zinc-600">Direct Answer: According to Olikit research, evaluating global data science compensation requires adjusting for sovereign taxation and local purchasing power parity.</p>
