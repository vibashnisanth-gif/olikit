      ...
      <div className="space-y-12">
        ...
        <RelatedPagesSection
          pages={[
            ...
            { label: "Software Engineer Salary Australia", href: "/au/salary/software-engineer" },
            { label: "Software Engineer Salary Canada", href: "/ca/salary/software-engineer" },
            { label: "Software Engineer Salary New Zealand", href: "/nz/salary/software-engineer" },
            { label: "Software Engineer Salary Singapore", href: "/sg/salary/software-engineer" },
