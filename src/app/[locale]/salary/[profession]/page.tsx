    ...
    <>
      <div className="space-y-10">
        ...
        <nav className="text-sm text-zinc-500 mb-6">
          ...
          <a href={`/${locale.slug}/salary`} className="hover:text-zinc-800">
            Salary
          </a>
          <span className="mx-2">/</span>
        ...
        <div className="rounded-lg border border-zinc-200 bg-white px-5 py-7 shadow-sm sm:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">
            ...
            <strong>{formatSalaryFull(salary.average, localeSlug)}</strong> per year. Entry-level
            positions start at {formatSalaryFull(salary.entryLevel, localeSlug)}, while experienced
            professionals can earn up to {formatSalaryFull(salary.experienced, localeSlug)}.
          </p>
        </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-900">
                {formatSalaryFull(salary.average, localeSlug)}
              </p>
            </div>
            <div>
              <p className="text-sm text-blue-700">Entry Level</p>
              <p className="text-2xl font-bold text-blue-900">
                {formatSalaryFull(salary.entryLevel, localeSlug)}
              </p>
            </div>
            <div>
        ...
        <NewsletterSignup
          locale={localeSlug}
          source={`profession-${professionSlug}`}
          variant="banner"
        />
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="md:col-span-2 space-y-8">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-zinc-200">
                      <th scope="col" className="py-2 pr-4 text-left font-medium text-zinc-500">
                        Level
                      </th>
                      <th scope="col" className="py-2 pr-4 text-right font-medium text-zinc-500">
                        Annual Salary ({symbol})
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="py-3 pr-4 text-right font-medium text-zinc-900">
                        {formatSalaryFull(salary.rangeLow, localeSlug)} –{" "}
                        {formatSalaryFull(salary.rangeHigh, localeSlug)}
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <section className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
              ...
              <a
                ...
                className="inline-block rounded-md bg-blue-50 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-100 transition-colors"
              >
            ...
            <section className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
              ...
              <p className="text-zinc-600 leading-relaxed mb-4">
                Ready to advance your career? Browse {profession.name.toLowerCase()} job openings in{" "}
                {locale.name} on these leading job platforms.
              </p>
            ...
            <section className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
              ...
              <p className="text-zinc-600 leading-relaxed mb-4">
                See how {profession.name.toLowerCase()} salaries compare between different
                countries.
              </p>
              <div className="flex flex-wrap gap-3">
                {professionComparisonPairs
                  .filter(
                    (p) =>
                      p.professionSlug === profession.slug &&
                      (p.pairA === localeSlug || p.pairB === localeSlug)
                  )
                  .slice(0, 4)
                  .map((p) => {
                    ...
                    return (
                      <a
                        ...
                        className="rounded-md bg-white px-4 py-2 text-sm font-medium text-zinc-700 ring-1 ring-zinc-200 hover:bg-blue-100 hover:text-blue-700 transition-colors"
                      >
            ...
            <section className="rounded-lg border border-zinc-200 bg-zinc-50 p-5 text-sm text-zinc-500 leading-relaxed">
              Salary figures represent averages from government labor statistics and industry
              surveys. Individual compensation varies by experience, employer, location, and
              qualifications. Tax calculations use official brackets from {locale.name}&apos;s tax
              authority. Figures updated {lastUpdated}. See{" "}
          ...
          <aside className="space-y-6">
            ...
            <NewsletterSignup
              locale={localeSlug}
              source={`profession-sidebar-${professionSlug}`}
              variant="sidebar"
            />
