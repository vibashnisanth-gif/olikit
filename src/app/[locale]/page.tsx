...
const COUNTRY_CONTENT: Record<string, {
  ...
  sg: {
    ...
    faqQs: [
      ...
      { q: "Can I compare salaries internationally?", a: "Yes. Comparing salaries alongside taxes, housing costs and purchasing power provides a more complete picture of financial outcomes." },
      { q: "What sources does Olikit use?", a: "Olikit relies on official Singapore government publications including IRAS individual income tax rates, CPF Board contribution schedules, Department of Statistics Singapore labour market data, and Ministry of Trade and Industry economic indicators." },
      { q: "How often is data updated?", a: "IRAS tax rates and CPF contribution rates are updated at the start of each calendar year when the Singapore budget is announced. SingStat wage data is published through annual comprehensive labour market reports." },
      { q: "Are Olikit calculators free to use?", a: "Yes. All Olikit calculators, salary guides, and research resources are available at no charge." },
    ],
  },
}
