    ...
    <div className="space-y-10">
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href={`/${locale.slug}/tools/salary-calculator`} className="rounded-md bg-zinc-950 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-800">Salary Calculator</Link>
          <Link href={`/${locale.slug}/tools/tax-calculator`} className="rounded-md bg-white px-4 py-2 text-sm font-medium text-zinc-700 ring-1 ring-zinc-200 hover:bg-zinc-50">Tax Calculator</Link>
          {report.relatedPages.map((page) => (
            <Link key={page.href} href={page.href} className="rounded-md bg-white px-4 py-2 text-sm font-medium text-zinc-700 ring-1 ring-zinc-200 hover:bg-zinc-50">{page.label}</Link>
          ))}
