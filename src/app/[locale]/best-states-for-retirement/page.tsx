...
export async function generateMetadata({params}: Props): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Top US states ranked for retirement based on cost of living, tax friendliness, and healthcare costs. Find the best state to retire.",
    ...
    <div className="space-y-10">
            ...
            {data.rankings.map((r) => (
              <tr key={r.stateSlug} className="border-b border-zinc-100 last:border-0">
                ...
                <td className="px-4 py-3">
                  <Link
                    href={`/${locale.slug}/salary-vs-cost-of-living/${r.stateSlug}`}
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            href={`/${locale.slug}/tools/retirement-calculator`}
            className="rounded-md bg-white px-4 py-2 text-sm font-medium text-zinc-700 ring-1 ring-zinc-200 hover:bg-zinc-50"
          >
