...
export async function generateMetadata({params}: Props): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Thorough financial glossary covering salary, tax, mortgage, and investment terms. Clear definitions, real examples, and links to related calculators and guides.",
    ...
    <div className="space-y-10">
      <div className="rounded-lg border border-zinc-200 bg-white px-5 py-7 shadow-sm sm:px-8">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">
          Clear definitions and real examples of essential financial terms. Each entry includes
          examples, FAQs, and links to related calculators and guides on Olikit.
        </p>
      </div>
              ...
              .map((entry) => (
                ...
                >
                  <h3 className="mb-2 text-lg font-semibold text-zinc-950">
                    <Link
                      href={`/${locale.slug}/glossary/${entry.slug}`}
