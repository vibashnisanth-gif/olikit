    ...
    <div className="space-y-12">
      <section className="rounded-lg border border-zinc-200 bg-white px-5 py-10 shadow-sm sm:px-8 sm:py-12">
        ...
        <p className="mt-4 max-w-2xl text-lg leading-8 text-zinc-600">
          Practical guides to help you make better financial decisions in {name}. Learn about salary
          after tax, tax brackets, mortgage affordability, retirement planning, and compound
          interest.
        </p>
      </section>
