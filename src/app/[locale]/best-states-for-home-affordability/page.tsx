...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Top US states ranked by home affordability. Compare home price-to-income ratios, mortgage affordability, and property taxes.",
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-200 bg-zinc-50">
              ...
              <th scope="col" className="px-4 py-3 text-left font-semibold text-zinc-700">Home Price-to-Income Ratio</th>
            </tr>
          </thead>
          <tbody>
            {data.rankings.map((r) => (
