...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/comparisons/software-engineer-us-vs-australia` },
  openGraph: {
    ...
    url: `${SITE_URL}/comparisons/software-engineer-us-vs-australia`,
    siteName: "Olikit",
    type: "website",
  },
}
    ...
    <Shell>
      <div className="space-y-12">
        ...
        <CountryComparisonSection
          ...
          overview="BLOCKED — Awaiting Content. This comparison examines the key differences for software engineers between the United States and Australia."
        />

        <ExecutiveSummarySection
          summary="BLOCKED — Awaiting Content. Executive summary comparing software engineer careers in the US vs Australia."
        />
