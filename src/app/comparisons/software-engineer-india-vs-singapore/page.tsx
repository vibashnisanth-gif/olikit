...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/comparisons/software-engineer-india-vs-singapore` },
  openGraph: {
    ...
    url: `${SITE_URL}/comparisons/software-engineer-india-vs-singapore`,
    siteName: "Olikit",
    type: "website",
  },
}
    ...
    <Shell>
      <div className="space-y-12">
        ...
        <CountryComparisonSection
          ...
          overview="BLOCKED — Awaiting Content. This comparison examines the key differences for software engineers between India and Singapore."
        />

        <ExecutiveSummarySection
          summary="BLOCKED — Awaiting Content. Executive summary comparing software engineer careers in India vs Singapore."
        />
        ...
        <RelatedPagesSection
          pages={[
            ...
            { label: "Software Engineer UK vs Australia", href: "/comparisons/software-engineer-uk-vs-australia" },
          ]}
        />
      </div>
    </Shell>
