...
const SALARY = { average: 1000000, entryLevel: 350000, experienced: 2000000 }

export const metadata: Metadata = {
  title: "Cloud Engineer Salary in the India (2026)",
  description: "Research cloud engineer salaries in the India. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/cloud-engineer-salary-in` },
  openGraph: {
    title: "Cloud Engineer Salary in the India",
    description: "Research cloud engineer salaries in the India.",
  },
}

export default function cloud_engineerSalaryIN() {
  const articleSchema = buildArticleJsonLd(
    "Cloud Engineer Salary in the India (2026)",
    "Research cloud engineer salaries in the India.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Cloud Engineer Salary India", url: `${SITE_URL}/cloud-engineer-salary-in` },
  ])
    ...
    <Shell>
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <h1 className="max-w-4xl text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">Cloud Engineer Salary in the India</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">The India offers competitive salaries for cloud engineers across various industries and experience levels.</p>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Competitive Salaries</h3><p className="text-sm leading-6 text-zinc-700">The average cloud engineer salary in the India is {COUNTRY.currency}{SALARY.average.toLocaleString("en-US")}.</p></div>
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Career Growth</h3><p className="text-sm leading-6 text-zinc-700">Career prospects for cloud engineers in the India remain strong with growing demand.</p></div>
          </div>
        </section>
