...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇮🇳", name: "India", salary: "₹5.5L", note: "" },
        { rank: 2, flag: "🇦🇺", name: "Australia", salary: "A$75,000", note: "" },
        { rank: 3, flag: "🇺🇸", name: "United States", salary: "$70,000", note: "" },
        { rank: 4, flag: "🇨🇦", name: "Canada", salary: "C$58,000", note: "" },
        { rank: 5, flag: "🇳🇿", name: "New Zealand", salary: "NZ$58,000", note: "" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", salary: "S$48,000", note: "" },
        { rank: 7, flag: "🇬🇧", name: "United Kingdom", salary: "£38,000", note: "" },
      ],
    },
    faqs: [
