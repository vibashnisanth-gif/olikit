  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        ...
        { rank: 2, flag: "🇦🇺", name: "Australia", salary: "A$108,000", note: "" },
        { rank: 3, flag: "🇺🇸", name: "United States", salary: "$115,000", note: "" },
        { rank: 4, flag: "🇨🇦", name: "Canada", salary: "C$82,000", note: "" },
        { rank: 5, flag: "🇳🇿", name: "New Zealand", salary: "NZ$88,000", note: "" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", salary: "S$70,000", note: "" },
        { rank: 7, flag: "🇬🇧", name: "United Kingdom", salary: "£52,000", note: "" },
      ],
    },
    faqs: [
