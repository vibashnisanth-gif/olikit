...
const SALARY = { average: 58000, entryLevel: 32000, experienced: 90000 }

export const metadata: Metadata = {
  title: "Data Scientist Salary in the United Kingdom (2026)",
  description: "Research data scientist salaries in the United Kingdom. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/data-scientist-salary-${COUNTRY.slug}` },
  openGraph: { title: "Data Scientist Salary in the United Kingdom", description: "Research data scientist salaries in the United Kingdom." },
}

export default function DataScientistUK() {
  const articleSchema = buildArticleJsonLd(
    "Data Scientist Salary in the United Kingdom (2026)",
    "Research data scientist salaries in the United Kingdom. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
    `/data-scientist-salary-${COUNTRY.slug}`,
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Data Scientist Salary UK", url: `${SITE_URL}/data-scientist-salary-${COUNTRY.slug}` },
  ])
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a href="/uk/salary/data-scientist" className="rounded-md bg-zinc-100 px-5 py-2.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200">Full Salary Page</a>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Strong Fintech Sector</h3><p className="text-sm leading-6 text-zinc-600">London's financial technology sector continues to drive demand for data scientists across banking, payments and insurance.</p></div>
        ...
        <section className="rounded-lg border border-zinc-200 bg-white px-5 py-6 shadow-sm sm:px-8">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <a href="/uk/salary/data-scientist" className="rounded-md bg-zinc-100 px-3 py-1.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200">Full Salary Page</a>
