...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇺🇸", name: "United States", salary: "$135,000", note: "Highest AI salaries globally" },
        { rank: 2, flag: "🇦🇺", name: "Australia", salary: "A$125,000", note: "Competitive AI salaries and lifestyle" },
        { rank: 3, flag: "🇨🇦", name: "Canada", salary: "C$95,000", note: "Growing AI hubs in Toronto and Montreal" },
        { rank: 4, flag: "🇳🇿", name: "New Zealand", salary: "NZ$105,000", note: "Emerging AI sector" },
        { rank: 5, flag: "🇬🇧", name: "United Kingdom", salary: "£62,000", note: "Strong AI research sector in London" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", salary: "S$85,000", note: "Competitive salaries, low taxes" },
        { rank: 7, flag: "🇮🇳", name: "India", salary: "₹18.0L", note: "Large AI talent pool, strong PPP" },
      ],
    },
    faqs: [
