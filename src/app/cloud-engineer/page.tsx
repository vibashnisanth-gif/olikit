...
const pagePath = "/cloud-engineer"
const seoTitle = "Cloud Engineer Salary & Career Intelligence (2026)"
const seoDesc = "Research cloud engineer salaries, compare compensation across countries, evaluate career progression, and understand how cloud computing expertise affects earnings."

export const metadata: Metadata = buildProfessionMetadata(seoTitle, seoDesc, pagePath)

const prof = getProfession("cloud-engineer")!
...
export default function cloud_engineerHubPage() {
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    { label: "Home", url: SITE_URL },
    { label: "Cloud Engineer", url: `${SITE_URL}${pagePath}` },
  ])
  ...
  const countryEntries = countrySlugs.map((slug) => {
    ...
    return {
      ...
      slug,
      summary: `Average cloud engineer salary in ${COUNTRY_NAMES[slug] || slug} is ${formatSalary(salary.average, slug)} per year.`,
      metrics: [
  ...
  const content: ProfessionPageContent = {
    ...
    hero: {
      ...
      title: "Cloud Engineer Salary & Career Intelligence",
      description: "Research cloud engineer salaries, compare compensation across countries, evaluate career progression, and understand how cloud computing expertise affects earnings.",
      cta: { label: "View Salary by Country", href: "/cloud-engineer-salary-by-country" },
      secondaryCta: { label: "Salary Index 2026", href: "/research/cloud-engineer-salary-index-2026" },
    },
    salaryCards: [
    ...
    faqs: [
      { question: "Which country pays cloud engineers the most in 2026?", answer: "The United States offers the highest average cloud engineer salaries at approximately $115,000 per year. Australia and Canada follow with competitive compensation packages." },
      { question: "Which country has the lowest taxes for cloud engineers?", answer: "Singapore has the lowest personal income tax burden among analyzed countries, with a top marginal rate of 22% and an effective rate of approximately 7% for average earners." },
      { question: "Which country offers the best value considering cost of living?", answer: "India offers the strongest purchasing power relative to local costs. Despite lower nominal salaries, the significantly lower cost of living allows cloud engineers to achieve a high standard of living." },
    ...
    relatedPages: [
      { label: "Cloud Engineer Salary", href: "/cloud-engineer-salary" },
      ...
      { label: "Best Countries Overview", href: "/cloud-engineer-best-countries" },
      ...
      { label: "Salary Index 2026", href: "/research/cloud-engineer-salary-index-2026" },    ],
  }
