...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇮🇳", name: "India", salary: "₹18.0L", note: "" },
        { rank: 2, flag: "🇦🇺", name: "Australia", salary: "A$125,000", note: "" },
        { rank: 3, flag: "🇺🇸", name: "United States", salary: "$135,000", note: "" },
        { rank: 4, flag: "🇨🇦", name: "Canada", salary: "C$95,000", note: "" },
        { rank: 5, flag: "🇳🇿", name: "New Zealand", salary: "NZ$105,000", note: "" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", salary: "S$85,000", note: "" },
        { rank: 7, flag: "🇬🇧", name: "United Kingdom", salary: "£62,000", note: "" },
      ],
    },
    faqs: [
