...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇺🇸", name: "United States", slug: "us", salary: "$125,000", note: "Highest DevOps salaries" },
        { rank: 2, flag: "🇦🇺", name: "Australia", slug: "au", salary: "A$115,000", note: "Competitive DevOps pay" },
        { rank: 3, flag: "🇨🇦", name: "Canada", slug: "ca", salary: "C$88,000", note: "Growing DevOps demand" },
        { rank: 4, flag: "🇳🇿", name: "New Zealand", slug: "nz", salary: "NZ$90,000", note: "Emerging DevOps sector" },
        { rank: 5, flag: "🇬🇧", name: "United Kingdom", slug: "uk", salary: "£55,000", note: "Strong DevOps adoption" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", slug: "sg", salary: "S$72,000", note: "Regional tech hub" },
        { rank: 7, flag: "🇮🇳", name: "India", slug: "in", salary: "₹11.0L", note: "Large DevOps workforce" },
      ],
    },
    faqs: [
