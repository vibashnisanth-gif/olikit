...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇺🇸", name: "United States", salary: "$130,000", note: "Highest ML salaries globally" },
        { rank: 2, flag: "🇦🇺", name: "Australia", salary: "A$120,000", note: "Competitive ML salaries" },
        { rank: 3, flag: "🇨🇦", name: "Canada", salary: "C$90,000", note: "Growing ML research hubs" },
        { rank: 4, flag: "🇳🇿", name: "New Zealand", salary: "NZ$100,000", note: "Emerging ML sector" },
        { rank: 5, flag: "🇬🇧", name: "United Kingdom", salary: "£60,000", note: "Strong AI/ML sector" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", salary: "S$82,000", note: "Strong fintech ML roles" },
        { rank: 7, flag: "🇮🇳", name: "India", salary: "₹16.0L", note: "Large ML talent pool" },
      ],
    },
    faqs: [
