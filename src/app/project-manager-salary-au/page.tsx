...
export const metadata: Metadata = {
  title: "Project Manager Salary in the Australia (2026)",
  description: "Research project manager salaries in the Australia. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/project-manager-salary-au` },
  openGraph: {
    title: "Project Manager Salary in the Australia",
    description: "Research project manager salaries in the Australia.",
  },
}

export default function project_managerSalaryAU() {
  const articleSchema = buildArticleJsonLd(
    "Project Manager Salary in the Australia (2026)",
    "Research project manager salaries in the Australia.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Project Manager Salary Australia", url: `${SITE_URL}/project-manager-salary-au` },
  ])
    ...
    <Shell>
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <h1 className="max-w-4xl text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">Project Manager Salary in the Australia</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">The Australia offers competitive salaries for project managers across various industries and experience levels.</p>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Competitive Salaries</h3><p className="text-sm leading-6 text-zinc-700">The average project manager salary in the Australia is {COUNTRY.currency}{SALARY.average.toLocaleString("en-US")}.</p></div>
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Career Growth</h3><p className="text-sm leading-6 text-zinc-700">Career prospects for project managers in the Australia remain strong with growing demand.</p></div>
          </div>
        </section>
