    ...
    <Shell>
      ...
      <div className="space-y-12">
        ...
        <section className="rounded-lg border border-zinc-200 bg-zinc-50 px-5 py-6 shadow-sm sm:px-8">
          ...
          <p className="mb-3 text-sm leading-7 text-zinc-600">Data science remains a growing profession in New Zealand, with demand across technology, financial services, agriculture and government sectors.</p>
          <p className="mb-3 text-sm leading-7 text-zinc-600">New Zealand's technology sector has seen increased investment and international attention, creating new opportunities for skilled data scientists.</p>
