    ...
    <Shell>
      ...
      <div className="space-y-12">
        ...
        <section className="rounded-lg border border-zinc-200 bg-zinc-50 px-5 py-6 shadow-sm sm:px-8">
          ...
          <p className="mb-3 text-sm leading-7 text-zinc-600">Data science is a high-demand profession in Singapore, driven by the city-state's role as a global financial and technology hub.</p>
