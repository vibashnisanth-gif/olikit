...
export const metadata: Metadata = {
  title: "Product Manager vs Software Engineer: Salary & Career Comparison (2026)",
  ...
  openGraph: {
    title: "Product Manager vs Software Engineer: Salary & Career Comparison (2026) | Olikit",
