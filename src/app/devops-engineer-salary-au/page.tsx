...
export const metadata: Metadata = {
  title: "DevOps Engineer Salary in the Australia (2026)",
  description: "Research devops engineer salaries in the Australia. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/devops-engineer-salary-au` },
  openGraph: {
    title: "DevOps Engineer Salary in the Australia",
    description: "Research devops engineer salaries in the Australia.",
  },
}

export default function devops_engineerSalaryAU() {
  const articleSchema = buildArticleJsonLd(
    "DevOps Engineer Salary in the Australia (2026)",
    "Research devops engineer salaries in the Australia.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "DevOps Engineer Salary Australia", url: `${SITE_URL}/devops-engineer-salary-au` },
  ])
      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Competitive Salaries</h3><p className="text-sm leading-6 text-zinc-700">The average devops engineer salary in the Australia is {COUNTRY.currency}{SALARY.average.toLocaleString("en-US")}.</p></div>
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Career Growth</h3><p className="text-sm leading-6 text-zinc-700">Career prospects for devops engineers in the Australia remain strong with growing demand.</p></div>
          </div>
        </section>
