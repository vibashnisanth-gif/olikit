...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇺🇸", name: "United States", slug: "us", salary: "$97,500 (22% tax)" },
        { rank: 2, flag: "🇦🇺", name: "Australia", slug: "au", salary: "A$86,250 (25% tax)" },
        { rank: 3, flag: "🇸🇬", name: "Singapore", slug: "sg", salary: "S$66,960 (7% tax)" },
        { rank: 4, flag: "🇨🇦", name: "Canada", slug: "ca", salary: "C$66,000 (25% tax)" },
        { rank: 5, flag: "🇳🇿", name: "New Zealand", slug: "nz", salary: "NZ$67,500 (25% tax)" },
        { rank: 6, flag: "🇬🇧", name: "United Kingdom", slug: "uk", salary: "£44,000 (20% tax)" },
        { rank: 7, flag: "🇮🇳", name: "India", slug: "in", salary: "₹8.8L (20% tax)" },
      ],
    },
    faqs: [
