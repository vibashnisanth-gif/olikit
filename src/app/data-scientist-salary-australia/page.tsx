    ...
    <Shell>
      ...
      <div className="space-y-12">
        ...
        <section className="rounded-lg border border-zinc-200 bg-zinc-50 px-5 py-6 shadow-sm sm:px-8">
          ...
          <p className="mb-3 text-sm leading-7 text-zinc-600">Data science remains a high-demand profession in Australia, with opportunities spanning technology, financial services, mining and government sectors.</p>
          <p className="mb-3 text-sm leading-7 text-zinc-600">The technology workforce continues to grow, with increasing demand for experienced data scientists in machine learning, artificial intelligence and big data.</p>
