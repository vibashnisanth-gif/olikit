...
const SALARY = { average: 115000, entryLevel: 70000, experienced: 165000 }

export const metadata: Metadata = {
  title: "Data Scientist Salary in Australia (2026)",
  description: "Research data scientist salaries in Australia. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/data-scientist-salary-australia` },
  openGraph: { title: "Data Scientist Salary in Australia", description: "Research data scientist salaries in Australia." },
}

export default function DataScientistAU() {
  const articleSchema = buildArticleJsonLd(
    "Data Scientist Salary in Australia (2026)",
    "Research data scientist salaries in Australia. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Data Scientist Salary Australia", url: `${SITE_URL}/data-scientist-salary-australia` },
  ])
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a href="/au/salary/data-scientist" className="rounded-md bg-zinc-100 px-5 py-2.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200">Full Salary Page</a>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Strong Compensation</h3><p className="text-sm leading-6 text-zinc-600">Australia offers some of the highest data scientist salaries outside North America.</p></div>
        ...
        <section className="rounded-lg border border-zinc-200 bg-zinc-50 px-5 py-6 shadow-sm sm:px-8">
          <h2 className="mb-4 text-2xl font-semibold text-zinc-950">Australia Data Scientist Salary Landscape</h2>
          <p className="mb-3 text-sm leading-7 text-zinc-700">Data science remains a high-demand profession in Australia, with opportunities spanning technology, financial services, mining and government sectors.</p>
          <p className="mb-3 text-sm leading-7 text-zinc-700">The technology workforce continues to grow, with increasing demand for experienced data scientists in machine learning, artificial intelligence and big data.</p>
          <p className="mb-3 text-sm leading-7 text-zinc-700">When evaluating compensation, professionals should consider salary alongside superannuation, tax obligations and regional housing costs.</p>
        </section>
        ...
        <section className="rounded-lg border border-zinc-200 bg-white px-5 py-6 shadow-sm sm:px-8">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <a href="/au/salary/data-scientist" className="rounded-md bg-zinc-100 px-3 py-1.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200">Full Salary Page</a>
