  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <nav className="mb-6 text-sm text-gray-500">
        ...
        <Link href="/us/tools" className="hover:text-blue-700">
          Tools
        </Link>
        <span className="mx-2">/</span>
      ...
      <section className="mt-12 border-t pt-8">
        <h2 className="mb-4 text-xl font-semibold text-gray-900">Why Compare Salaries by City?</h2>
        <div className="prose prose-gray max-w-none">
          ...
          <p className="mb-4">
            Our tool compares two salaries using city-specific cost of living indices and tax rates,
            showing you:
          </p>
