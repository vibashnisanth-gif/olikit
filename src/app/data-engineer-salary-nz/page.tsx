...
const SALARY = { average: 88000, entryLevel: 55000, experienced: 130000 }

export const metadata: Metadata = {
  title: "Data Engineer Salary in the New Zealand (2026)",
  description: "Research data engineer salaries in the New Zealand. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/data-engineer-salary-nz` },
  openGraph: {
    title: "Data Engineer Salary in the New Zealand",
    description: "Research data engineer salaries in the New Zealand.",
  },
}

export default function data_engineerSalaryNZ() {
  const articleSchema = buildArticleJsonLd(
    "Data Engineer Salary in the New Zealand (2026)",
    "Research data engineer salaries in the New Zealand.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Data Engineer Salary New Zealand", url: `${SITE_URL}/data-engineer-salary-nz` },
  ])
    ...
    <Shell>
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <h1 className="max-w-4xl text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">Data Engineer Salary in the New Zealand</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">The New Zealand offers competitive salaries for data engineers across various industries and experience levels.</p>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Competitive Salaries</h3><p className="text-sm leading-6 text-zinc-700">The average data engineer salary in the New Zealand is {COUNTRY.currency}{SALARY.average.toLocaleString("en-US")}.</p></div>
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Career Growth</h3><p className="text-sm leading-6 text-zinc-700">Career prospects for data engineers in the New Zealand remain strong with growing demand.</p></div>
          </div>
        </section>
