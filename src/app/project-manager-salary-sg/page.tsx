...
const SALARY = { average: 55000, entryLevel: 32000, experienced: 85000 }

export const metadata: Metadata = {
  title: "Project Manager Salary in the Singapore (2026)",
  description: "Research project manager salaries in the Singapore. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/project-manager-salary-sg` },
  openGraph: {
    title: "Project Manager Salary in the Singapore",
    description: "Research project manager salaries in the Singapore.",
  },
}

export default function project_managerSalarySG() {
  const articleSchema = buildArticleJsonLd(
    "Project Manager Salary in the Singapore (2026)",
    "Research project manager salaries in the Singapore.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Project Manager Salary Singapore", url: `${SITE_URL}/project-manager-salary-sg` },
  ])
    ...
    <Shell>
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <h1 className="max-w-4xl text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">Project Manager Salary in the Singapore</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">The Singapore offers competitive salaries for project managers across various industries and experience levels.</p>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Competitive Salaries</h3><p className="text-sm leading-6 text-zinc-700">The average project manager salary in the Singapore is {COUNTRY.currency}{SALARY.average.toLocaleString("en-US")}.</p></div>
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Career Growth</h3><p className="text-sm leading-6 text-zinc-700">Career prospects for project managers in the Singapore remain strong with growing demand.</p></div>
          </div>
        </section>
