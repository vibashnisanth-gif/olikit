...
const pagePath = "/financial-analyst"
const seoTitle = "Financial Analyst Salary & Career Intelligence (2026)"
const seoDesc = "Research financial analyst salaries, compare compensation across countries, evaluate career progression, and understand how finance expertise affects earnings."

export const metadata: Metadata = buildProfessionMetadata(seoTitle, seoDesc, pagePath)

const prof = getProfession("financial-analyst")!
...
export default function financial_analystHubPage() {
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    { label: "Home", url: SITE_URL },
    { label: "Financial Analyst", url: `${SITE_URL}${pagePath}` },
  ])
  ...
  const countryEntries = countrySlugs.map((slug) => {
    ...
    return {
      ...
      slug,
      summary: `Average financial analyst salary in ${COUNTRY_NAMES[slug] || slug} is ${formatSalary(salary.average, slug)} per year.`,
      metrics: [
  ...
  const content: ProfessionPageContent = {
    ...
    hero: {
      ...
      title: "Financial Analyst Salary & Career Intelligence",
      description: "Research financial analyst salaries, compare compensation across countries, evaluate career progression, and understand how finance expertise affects earnings.",
      cta: { label: "View Salary by Country", href: "/financial-analyst-salary-by-country" },
      secondaryCta: { label: "Salary Index 2026", href: "/research/financial-analyst-salary-index-2026" },
    },
    salaryCards: [
    ...
    faqs: [
      { question: "Which country pays financial analysts the most in 2026?", answer: "The United States offers the highest average financial analyst salaries at approximately $75,000 per year. Australia and Canada follow with competitive compensation packages." },
      { question: "Which country has the lowest taxes for financial analysts?", answer: "Singapore has the lowest personal income tax burden among analyzed countries, with a top marginal rate of 22% and an effective rate of approximately 7% for average earners." },
      { question: "Which country offers the best value considering cost of living?", answer: "India offers the strongest purchasing power relative to local costs. Despite lower nominal salaries, the significantly lower cost of living allows financial analysts to achieve a high standard of living." },
    ...
    relatedPages: [
      { label: "Financial Analyst Salary", href: "/financial-analyst-salary" },
      ...
      { label: "Best Countries Overview", href: "/financial-analyst-best-countries" },
      ...
      { label: "Salary Index 2026", href: "/research/financial-analyst-salary-index-2026" },    ],
  }
