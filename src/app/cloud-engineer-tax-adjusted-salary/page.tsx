  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        ...
        { rank: 2, flag: "🇦🇺", name: "Australia", salary: "A$78,750 (25% tax)" },
        { rank: 3, flag: "🇸🇬", name: "Singapore", salary: "S$63,240 (7% tax)" },
        { rank: 4, flag: "🇨🇦", name: "Canada", salary: "C$61,500 (25% tax)" },
        { rank: 5, flag: "🇳🇿", name: "New Zealand", salary: "NZ$63,750 (25% tax)" },
        { rank: 6, flag: "🇬🇧", name: "United Kingdom", salary: "£40,000 (20% tax)" },
