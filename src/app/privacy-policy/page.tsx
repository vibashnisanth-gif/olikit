...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Privacy Policy",
    description: "Olikit privacy policy — how we handle data, cookies, analytics, and advertising.",
  },
}
  ...
  return (
    <Shell>
      ...
      <div className="max-w-3xl space-y-10">
        <section>
          <h1 className="text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">Privacy Policy</h1>
        ...
        <section>
          <h2 className="text-xl font-semibold text-zinc-950 mb-3">Information We Collect</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-zinc-950 mb-3">Google Analytics (GA4)</h2>
          <p className="text-zinc-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-zinc-950 mb-3">Google AdSense</h2>
          <p className="text-zinc-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-zinc-950 mb-3">Cookies</h2>
          <p className="text-zinc-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-zinc-950 mb-3">Data Sharing</h2>
          <p className="text-zinc-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-zinc-950 mb-3">Third-Party Links</h2>
          <p className="text-zinc-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-zinc-950 mb-3">Children&apos;s Privacy</h2>
          <p className="text-zinc-600 leading-relaxed">
