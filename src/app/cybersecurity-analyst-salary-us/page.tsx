...
const SALARY = { average: 105000, entryLevel: 65000, experienced: 160000 }

export const metadata: Metadata = {
  title: "Cybersecurity Analyst Salary in the United States (2026)",
  description: "Research cybersecurity analyst salaries in the United States. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/cybersecurity-analyst-salary-us` },
  openGraph: {
    title: "Cybersecurity Analyst Salary in the United States",
    description: "Research cybersecurity analyst salaries in the United States.",
  },
}

export default function cybersecurity_analystSalaryUS() {
  const articleSchema = buildArticleJsonLd(
    "Cybersecurity Analyst Salary in the United States (2026)",
    "Research cybersecurity analyst salaries in the United States.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Cybersecurity Analyst Salary United States", url: `${SITE_URL}/cybersecurity-analyst-salary-us` },
  ])
  ...
  return (
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <h1 className="max-w-4xl text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">Cybersecurity Analyst Salary in the United States</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">The United States offers competitive salaries for cybersecurity analysts across various industries and experience levels.</p>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Competitive Salaries</h3><p className="text-sm leading-6 text-zinc-700">The average cybersecurity analyst salary in the United States is {COUNTRY.currency}{SALARY.average.toLocaleString("en-US")}.</p></div>
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Career Growth</h3><p className="text-sm leading-6 text-zinc-700">Career prospects for cybersecurity analysts in the United States remain strong with growing demand.</p></div>
          </div>
        </section>
