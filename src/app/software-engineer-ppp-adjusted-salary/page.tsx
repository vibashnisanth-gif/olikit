...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "\u{1F1EE}\u{1F1F3}", name: "India", slug: "in", salary: "\u20b912,00,000 (~$14,400 USD PPP)", note: "Exceptional local purchasing power" },
        { rank: 2, flag: "\u{1F1E6}\u{1F1FA}", name: "Australia", slug: "au", salary: "A$110,000 (~$72,000 USD)" },
        { rank: 3, flag: "\u{1F1FA}\u{1F1F8}", name: "United States", slug: "us", salary: "$120,000" },
        { rank: 4, flag: "\u{1F1E8}\u{1F1E6}", name: "Canada", slug: "ca", salary: "C$85,000 (~$62,000 USD)" },
        { rank: 5, flag: "\u{1F1F3}\u{1F1FF}", name: "New Zealand", slug: "nz", salary: "NZ$95,000 (~$57,000 USD)" },
        { rank: 6, flag: "\u{1F1F8}\u{1F1EC}", name: "Singapore", slug: "sg", salary: "S$72,000 (~$53,000 USD)" },
