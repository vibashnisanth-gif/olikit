    ...
    <>
      ...
      <div className="space-y-12">
        ...
        <section className="rounded-lg border border-zinc-200 bg-zinc-50 px-5 py-6 shadow-sm sm:px-8">
          ...
          <p className="mb-3 text-sm leading-7 text-zinc-700">Software engineering continues to be one of the UK's most in-demand professional roles, with opportunities spanning technology, finance, healthcare and government sectors.</p>
