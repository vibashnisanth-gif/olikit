...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇺🇸", name: "United States", slug: "us", salary: "$115,000", note: "Highest DE salaries" },
        { rank: 2, flag: "🇦🇺", name: "Australia", slug: "au", salary: "A$108,000", note: "Competitive DE pay" },
        { rank: 3, flag: "🇨🇦", name: "Canada", slug: "ca", salary: "C$82,000", note: "Growing DE demand" },
        { rank: 4, flag: "🇳🇿", name: "New Zealand", slug: "nz", salary: "NZ$88,000", note: "Emerging DE sector" },
        { rank: 5, flag: "🇬🇧", name: "United Kingdom", slug: "uk", salary: "£52,000", note: "Strong data sector" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", slug: "sg", salary: "S$70,000", note: "Regional data hub" },
        { rank: 7, flag: "🇮🇳", name: "India", slug: "in", salary: "₹10.0L", note: "Large DE workforce" },
      ],
    },
    faqs: [
