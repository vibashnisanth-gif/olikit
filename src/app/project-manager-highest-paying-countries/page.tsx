...
export default function Page() {
  ...
  const content: ProfessionPageContent = {
    ...
    countryRanking: {
      ...
      entries: [
        { rank: 1, flag: "🇺🇸", name: "United States", slug: "us", salary: "$85,000", note: "Highest PM salaries" },
        { rank: 2, flag: "🇦🇺", name: "Australia", slug: "au", salary: "A$90,000", note: "Competitive PM pay" },
        { rank: 3, flag: "🇨🇦", name: "Canada", slug: "ca", salary: "C$68,000", note: "Growing PM demand" },
        { rank: 4, flag: "🇳🇿", name: "New Zealand", slug: "nz", salary: "NZ$70,000", note: "Smaller PM market" },
        { rank: 5, flag: "🇬🇧", name: "United Kingdom", slug: "uk", salary: "£42,000", note: "Strong PM profession" },
        { rank: 6, flag: "🇸🇬", name: "Singapore", slug: "sg", salary: "S$55,000", note: "Regional PM hub" },
        { rank: 7, flag: "🇮🇳", name: "India", slug: "in", salary: "₹8.0L", note: "Large PM workforce" },
      ],
    },
    faqs: [
