...
export const metadata: Metadata = {
  title: "Software Engineer vs Cybersecurity Analyst",
  description: "Compare software engineer and cybersecurity analyst salaries, career paths, and compensation across countries.",
  alternates: { canonical: `${SITE_URL}/software-engineer-vs-cybersecurity-analyst` },
  openGraph: { title: "Software Engineer vs Cybersecurity Analyst", description: "Compare software engineer and cybersecurity analyst compensation." },
}
    ...
    <Shell>
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">A detailed comparison of compensation, career progression and opportunities for software engineers and cybersecurity analysts across major global markets.</p>
