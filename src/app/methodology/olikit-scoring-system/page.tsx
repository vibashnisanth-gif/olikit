  ...
  return (
      ...
      <div className="mx-auto max-w-3xl space-y-12">
        ...
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          <p className="mb-3 text-sm font-semibold uppercase tracking-wider text-blue-700">Methodology</p>
        ...
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-8 shadow-sm sm:px-8">
          ...
          <div className="overflow-hidden rounded-lg border border-zinc-200 shadow-sm">
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-t border-zinc-100"><td className="px-4 py-3 font-medium text-zinc-950">90-100</td><td className="px-4 py-3 font-semibold text-blue-700">Exceptional</td><td className="px-4 py-3 text-zinc-600">Top-tier global compensation. Market-leading salaries with significant bonus and equity potential.</td></tr>
                <tr className="border-t border-zinc-100"><td className="px-4 py-3 font-medium text-zinc-950">80-89</td><td className="px-4 py-3 font-semibold text-blue-700">Strong</td><td className="px-4 py-3 text-zinc-600">Highly competitive compensation. Above-median salaries with good variable pay opportunities.</td></tr>
        ...
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-8 shadow-sm sm:px-8">
          ...
          <div className="overflow-hidden rounded-lg border border-zinc-200 shadow-sm">
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-t border-zinc-100"><td className="px-4 py-3 font-medium text-zinc-950">90-100</td><td className="px-4 py-3 font-semibold text-blue-700">Exceptional</td><td className="px-4 py-3 text-zinc-600">Net income provides substantial discretionary spending after all essential costs.</td></tr>
                <tr className="border-t border-zinc-100"><td className="px-4 py-3 font-medium text-zinc-950">75-89</td><td className="px-4 py-3 font-semibold text-blue-700">Strong</td><td className="px-4 py-3 text-zinc-600">Good balance of income and costs with meaningful savings potential.</td></tr>
        ...
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-8 shadow-sm sm:px-8">
          ...
          <div className="overflow-hidden rounded-lg border border-zinc-200 shadow-sm">
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-t border-zinc-100"><td className="px-4 py-3 font-medium text-zinc-950">85-100</td><td className="px-4 py-3 font-semibold text-blue-700">Open</td><td className="px-4 py-3 text-zinc-600">Streamlined immigration pathways, clear residency routes, strong quality of life.</td></tr>
                <tr className="border-t border-zinc-100"><td className="px-4 py-3 font-medium text-zinc-950">70-84</td><td className="px-4 py-3 font-semibold text-blue-700">Accessible</td><td className="px-4 py-3 text-zinc-600">Structured visa programmes with moderate processing times. Good expatriate support infrastructure.</td></tr>
        ...
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-8 shadow-sm sm:px-8">
          ...
          <div className="overflow-hidden rounded-lg border border-zinc-200 shadow-sm">
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-t border-zinc-100"><td className="px-4 py-3 font-medium text-zinc-950">90-100</td><td className="px-4 py-3 font-semibold text-blue-700">Global Leader</td><td className="px-4 py-3 text-zinc-600">Deep talent market with high employer density, diverse industries, and strong long-term demand.</td></tr>
                <tr className="border-t border-zinc-100"><td className="px-4 py-3 font-medium text-zinc-950">75-89</td><td className="px-4 py-3 font-semibold text-blue-700">Strong</td><td className="px-4 py-3 text-zinc-600">Robust market with good employer variety and healthy talent demand. Solid advancement infrastructure.</td></tr>
