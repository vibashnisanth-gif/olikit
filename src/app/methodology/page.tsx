  ...
  return (
      ...
      <section>
        ...
        <p className="text-sm leading-7 text-zinc-600">
          Olikit uses five proprietary scoring systems to evaluate compensation, purchasing power, relocation feasibility, career opportunities, and net earning potential. These scores power our country comparisons, rankings, and global research reports. <a href="/methodology/olikit-scoring-system" className="text-blue-700 hover:text-blue-600 font-medium">View the full scoring methodology →</a>
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-sm leading-7 text-zinc-600">
          Income tax calculations use official tax brackets, rates, and thresholds published by each country's tax authority. For the United States, we use <a href="https://www.irs.gov/pub/irs-drop/n-25-26.pdf" className="text-blue-700 hover:text-blue-600 font-medium">IRS Revenue Procedure tax tables</a> plus state-specific brackets where applicable. For the United Kingdom, we use <a href="https://www.gov.uk/government/publications/rates-and-allowances-income-tax/rates-and-allowances-income-tax" className="text-blue-700 hover:text-blue-600 font-medium">HMRC tax bands</a> including personal allowance, basic rate, higher rate, and additional rate. Australian calculations use <a href="https://www.ato.gov.au/tax-rates-and-codes/tax-rates" className="text-blue-700 hover:text-blue-600 font-medium">ATO tax rates</a> including the Medicare levy. Canadian calculations use <a href="https://www.canada.ca/en/revenue-agency/services/tax/individuals/federal-income-tax-rates.html" className="text-blue-700 hover:text-blue-600 font-medium">CRA federal and provincial tax brackets</a>. New Zealand uses <a href="https://www.ird.govt.nz/income-tax/income-tax-for-individuals" className="text-blue-700 hover:text-blue-600 font-medium">IRD tax bands</a>. India uses Indian Income Tax Department slabs with cess. Singapore uses <a href="https://www.iras.gov.sg/taxes/individual-income-tax/basics-of-individual-income-tax/tax-rates" className="text-blue-700 hover:text-blue-600 font-medium">IRAS progressive tax rates</a>.
        </p>
      ...
      <section>
        ...
        <p className="text-sm leading-7 text-zinc-600">
          Salary figures represent average annual salaries aggregated from government labor statistics, industry compensation surveys, and publicly available data sources for each country. Key sources include the <a href="https://www.bls.gov/oes/" className="text-blue-700 hover:text-blue-600 font-medium">BLS Occupational Employment and Wage Statistics (OEWS)</a> for the US, <a href="https://www.ons.gov.uk/employmentandlabourmarket/peopleinwork/earnings" className="text-blue-700 hover:text-blue-600 font-medium">ONS Annual Survey of Hours and Earnings (ASHE)</a> for the UK, and equivalent statistical publications in Australia, Canada, New Zealand, India, and Singapore. Data is updated on a periodic basis. Figures are indicative averages and may vary based on experience, location, industry, and other factors.
        </p>
      </section>
