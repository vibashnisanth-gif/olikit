...
const SALARY = { average: 120000, entryLevel: 72000, experienced: 175000 }

export const metadata: Metadata = {
  title: "Machine Learning Engineer Salary in the Australia (2026)",
  description: "Research machine learning engineer salaries in the Australia. Compare compensation across experience levels, understand taxes and evaluate purchasing power.",
  alternates: { canonical: `${SITE_URL}/machine-learning-engineer-salary-au` },
  openGraph: {
    title: "Machine Learning Engineer Salary in the Australia",
    description: "Research machine learning engineer salaries in the Australia.",
  },
}

export default function machine_learning_engineerSalaryAU() {
  const articleSchema = buildArticleJsonLd(
    "Machine Learning Engineer Salary in the Australia (2026)",
    "Research machine learning engineer salaries in the Australia.",
  ...
  const breadcrumbSchema = buildBreadcrumbJsonLd([
    ...
    { label: "Machine Learning Engineer Salary Australia", url: `${SITE_URL}/machine-learning-engineer-salary-au` },
  ])
    ...
    <Shell>
      ...
      <div className="space-y-12">
        <section className="rounded-xl border border-zinc-200 bg-white px-6 py-10 shadow-sm sm:px-10 sm:py-14">
          ...
          <h1 className="max-w-4xl text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl">Machine Learning Engineer Salary in the Australia</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">The Australia offers competitive salaries for machine learning engineers across various industries and experience levels.</p>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Competitive Salaries</h3><p className="text-sm leading-6 text-zinc-700">The average machine learning engineer salary in the Australia is {COUNTRY.currency}{SALARY.average.toLocaleString("en-US")}.</p></div>
            <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm"><h3 className="mb-1.5 text-base font-semibold text-zinc-950">Career Growth</h3><p className="text-sm leading-6 text-zinc-700">Career prospects for machine learning engineers in the Australia remain strong with growing demand.</p></div>
          </div>
        </section>
