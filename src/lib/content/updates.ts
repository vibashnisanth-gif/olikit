...
export const updates: UpdateEntry[] = [
  ...
  },
  {
    ...
    category: "site",
    description: "Initial launch of Olikit.com with 400+ localized calculator pages covering salary, tax, mortgage, investment, retirement, business loan, and profit margin calculations for 7 countries.",
    source: "Olikit Engineering",
    relatedPages: [
