...
export const professionsContent: Record<string, ProfessionContentMap> = {
  us: {
    ...
    "ai-engineer": generateContent("AI Engineer", "AI Engineers", "United States", "us", "$", 135000),
    "machine-learning-engineer": generateContent("Machine Learning Engineer", "Machine Learning Engineers", "United States", "us", "$", 130000),
    "cloud-engineer": generateContent("Cloud Engineer", "Cloud Engineers", "United States", "us", "$", 115000),
    "cybersecurity-analyst": generateContent("Cybersecurity Analyst", "Cybersecurity Analysts", "United States", "us", "$", 105000),
    "devops-engineer": generateContent("DevOps Engineer", "DevOps Engineers", "United States", "us", "$", 125000),
    "financial-analyst": generateContent("Financial Analyst", "Financial Analysts", "United States", "us", "$", 75000),
    "business-analyst": generateContent("Business Analyst", "Business Analysts", "United States", "us", "$", 70000),
    "project-manager": generateContent("Project Manager", "Project Managers", "United States", "us", "$", 85000),
    "solutions-architect": generateContent("Solutions Architect", "Solutions Architects", "United States", "us", "$", 140000),
    "data-engineer": generateContent("Data Engineer", "Data Engineers", "United States", "us", "$", 115000),
  },
  uk: {
    ...
    "ai-engineer": generateContent("AI Engineer", "AI Engineers", "United Kingdom", "uk", "\u00a3", 62000),
    "machine-learning-engineer": generateContent("Machine Learning Engineer", "Machine Learning Engineers", "United Kingdom", "uk", "\u00a3", 60000),
    "cloud-engineer": generateContent("Cloud Engineer", "Cloud Engineers", "United Kingdom", "uk", "\u00a3", 50000),
    "cybersecurity-analyst": generateContent("Cybersecurity Analyst", "Cybersecurity Analysts", "United Kingdom", "uk", "\u00a3", 48000),
    "devops-engineer": generateContent("DevOps Engineer", "DevOps Engineers", "United Kingdom", "uk", "\u00a3", 55000),
    "financial-analyst": generateContent("Financial Analyst", "Financial Analysts", "United Kingdom", "uk", "\u00a3", 40000),
    "business-analyst": generateContent("Business Analyst", "Business Analysts", "United Kingdom", "uk", "\u00a3", 38000),
    "project-manager": generateContent("Project Manager", "Project Managers", "United Kingdom", "uk", "\u00a3", 42000),
    "solutions-architect": generateContent("Solutions Architect", "Solutions Architects", "United Kingdom", "uk", "\u00a3", 65000),
    "data-engineer": generateContent("Data Engineer", "Data Engineers", "United Kingdom", "uk", "\u00a3", 52000),
  },
  au: {
    ...
    "ai-engineer": generateContent("AI Engineer", "AI Engineers", "Australia", "au", "A$", 125000),
    "machine-learning-engineer": generateContent("Machine Learning Engineer", "Machine Learning Engineers", "Australia", "au", "A$", 120000),
    "cloud-engineer": generateContent("Cloud Engineer", "Cloud Engineers", "Australia", "au", "A$", 105000),
    "cybersecurity-analyst": generateContent("Cybersecurity Analyst", "Cybersecurity Analysts", "Australia", "au", "A$", 100000),
    "devops-engineer": generateContent("DevOps Engineer", "DevOps Engineers", "Australia", "au", "A$", 115000),
    "financial-analyst": generateContent("Financial Analyst", "Financial Analysts", "Australia", "au", "A$", 80000),
    "business-analyst": generateContent("Business Analyst", "Business Analysts", "Australia", "au", "A$", 75000),
    "project-manager": generateContent("Project Manager", "Project Managers", "Australia", "au", "A$", 90000),
    "solutions-architect": generateContent("Solutions Architect", "Solutions Architects", "Australia", "au", "A$", 135000),
    "data-engineer": generateContent("Data Engineer", "Data Engineers", "Australia", "au", "A$", 108000),
  },
  ca: {
    ...
    "ai-engineer": generateContent("AI Engineer", "AI Engineers", "Canada", "ca", "C$", 95000),
    "machine-learning-engineer": generateContent("Machine Learning Engineer", "Machine Learning Engineers", "Canada", "ca", "C$", 90000),
    "cloud-engineer": generateContent("Cloud Engineer", "Cloud Engineers", "Canada", "ca", "C$", 82000),
    "cybersecurity-analyst": generateContent("Cybersecurity Analyst", "Cybersecurity Analysts", "Canada", "ca", "C$", 78000),
    "devops-engineer": generateContent("DevOps Engineer", "DevOps Engineers", "Canada", "ca", "C$", 88000),
    "financial-analyst": generateContent("Financial Analyst", "Financial Analysts", "Canada", "ca", "C$", 62000),
    "business-analyst": generateContent("Business Analyst", "Business Analysts", "Canada", "ca", "C$", 58000),
    "project-manager": generateContent("Project Manager", "Project Managers", "Canada", "ca", "C$", 68000),
    "solutions-architect": generateContent("Solutions Architect", "Solutions Architects", "Canada", "ca", "C$", 105000),
    "data-engineer": generateContent("Data Engineer", "Data Engineers", "Canada", "ca", "C$", 82000),
  },
  nz: {
    ...
    "ai-engineer": generateContent("AI Engineer", "AI Engineers", "New Zealand", "nz", "NZ$", 105000),
    "machine-learning-engineer": generateContent("Machine Learning Engineer", "Machine Learning Engineers", "New Zealand", "nz", "NZ$", 100000),
    "cloud-engineer": generateContent("Cloud Engineer", "Cloud Engineers", "New Zealand", "nz", "NZ$", 85000),
    "cybersecurity-analyst": generateContent("Cybersecurity Analyst", "Cybersecurity Analysts", "New Zealand", "nz", "NZ$", 80000),
    "devops-engineer": generateContent("DevOps Engineer", "DevOps Engineers", "New Zealand", "nz", "NZ$", 90000),
    "financial-analyst": generateContent("Financial Analyst", "Financial Analysts", "New Zealand", "nz", "NZ$", 62000),
    "business-analyst": generateContent("Business Analyst", "Business Analysts", "New Zealand", "nz", "NZ$", 58000),
    "project-manager": generateContent("Project Manager", "Project Managers", "New Zealand", "nz", "NZ$", 70000),
    "solutions-architect": generateContent("Solutions Architect", "Solutions Architects", "New Zealand", "nz", "NZ$", 115000),
    "data-engineer": generateContent("Data Engineer", "Data Engineers", "New Zealand", "nz", "NZ$", 88000),
  },
  in: {
    ...
    "ai-engineer": generateContent("AI Engineer", "AI Engineers", "India", "in", "\u20b9", 1800000),
    "machine-learning-engineer": generateContent("Machine Learning Engineer", "Machine Learning Engineers", "India", "in", "\u20b9", 1600000),
    "cloud-engineer": generateContent("Cloud Engineer", "Cloud Engineers", "India", "in", "\u20b9", 1000000),
    "cybersecurity-analyst": generateContent("Cybersecurity Analyst", "Cybersecurity Analysts", "India", "in", "\u20b9", 900000),
    "devops-engineer": generateContent("DevOps Engineer", "DevOps Engineers", "India", "in", "\u20b9", 1100000),
    "financial-analyst": generateContent("Financial Analyst", "Financial Analysts", "India", "in", "\u20b9", 600000),
    "business-analyst": generateContent("Business Analyst", "Business Analysts", "India", "in", "\u20b9", 550000),
    "project-manager": generateContent("Project Manager", "Project Managers", "India", "in", "\u20b9", 800000),
    "solutions-architect": generateContent("Solutions Architect", "Solutions Architects", "India", "in", "\u20b9", 2200000),
    "data-engineer": generateContent("Data Engineer", "Data Engineers", "India", "in", "\u20b9", 1000000),
  },
  sg: {
    ...
    "ai-engineer": generateContent("AI Engineer", "AI Engineers", "Singapore", "sg", "S$", 85000),
    "machine-learning-engineer": generateContent("Machine Learning Engineer", "Machine Learning Engineers", "Singapore", "sg", "S$", 82000),
    "cloud-engineer": generateContent("Cloud Engineer", "Cloud Engineers", "Singapore", "sg", "S$", 68000),
    "cybersecurity-analyst": generateContent("Cybersecurity Analyst", "Cybersecurity Analysts", "Singapore", "sg", "S$", 65000),
    "devops-engineer": generateContent("DevOps Engineer", "DevOps Engineers", "Singapore", "sg", "S$", 72000),
    "financial-analyst": generateContent("Financial Analyst", "Financial Analysts", "Singapore", "sg", "S$", 50000),
    "business-analyst": generateContent("Business Analyst", "Business Analysts", "Singapore", "sg", "S$", 48000),
    "project-manager": generateContent("Project Manager", "Project Managers", "Singapore", "sg", "S$", 55000),
    "solutions-architect": generateContent("Solutions Architect", "Solutions Architects", "Singapore", "sg", "S$", 90000),
    "data-engineer": generateContent("Data Engineer", "Data Engineers", "Singapore", "sg", "S$", 70000),
  },
}
