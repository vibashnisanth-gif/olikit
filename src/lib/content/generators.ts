  ...
  const stateContent: Record<string, Record<string, StateSpecificData>> = {
    california: {
      "salary-calculator": {
        ...
        faqs: [
          ...
          { question: "What is the minimum wage in California for 2025-2026?", answer: "California's minimum wage is $16.00 per hour for all employers as of January 2024, with annual inflation adjustments. Some cities and counties have higher local minimum wages, including Los Angeles at $16.78, San Francisco at $18.07, and Berkeley at $16.99, which take precedence over the state rate." },
      ...
      "tax-calculator": {
        ...
        faqs: [
          { question: "What is California's top marginal income tax rate for 2025-2026?", answer: "California's top marginal income tax rate is 13.3%, which applies to taxable income over $1,000,000. This includes the base top rate of 12.3% on income over $698,271 plus a 1% mental health services surcharge on income over $1,000,000, making it the highest state income tax rate in the nation." },
          ...
          { question: "How does the California standard deduction compare to federal?", answer: "California's standard deduction for 2025-2026 is $5,540 for single filers and $11,080 for married filing jointly, significantly lower than federal amounts of $14,600 and $29,200 respectively. California also offers additional standard deductions for blind and elderly taxpayers." },
    ...
    illinois: {
      "salary-calculator": {
        ...
        faqs: [
          { question: "What is Illinois's minimum wage in 2025?", answer: "Illinois's minimum wage is $14.00 per hour as of January 2024, scheduled to increase to $15.00 in 2025. Chicago has a higher minimum wage of $15.80 per hour. Tipped workers earn $8.40 per hour in Illinois with a tip credit to reach the standard minimum." },
    ...
    ohio: {
      ...
      "tax-calculator": {
        ...
        faqs: [
          { question: "What is Ohio's top income tax rate for 2025?", answer: "Ohio's top marginal income tax rate is 3.99%, applicable to taxable income over $138,600. This represents a significant reduction from 4.797% in 2021. The effective rate is lower for most taxpayers due to the $26,050 income exemption and progressive brackets." },
      ...
      "mortgage-calculator": {
        ...
        faqs: [
          ...
          { question: "What is the Ohio Housing market outlook for 2025-2026?", answer: "Ohio's housing market is expected to continue its moderate price appreciation of 3-5% annually, driven by low inventory, steady employment, and growing interest from out-of-state buyers. The Columbus market is expected to outperform due to Intel's investment, while Cleveland and Cincinnati should see steady but slower growth." },
        ],
      },
    },
    georgia: {
      ...
      "tax-calculator": {
        ...
        faqs: [
          { question: "What is Georgia's income tax rate for 2025?", answer: "Georgia's income tax rate ranges from 1% to 5.75% under the progressive system. The 5.75% rate applies to income over $7,000 for single filers ($10,000 for married filing jointly). The state is transitioning to a flat 5.49% rate by 2027." },
    ...
    "north-carolina": {
      ...
      "tax-calculator": {
        ...
        faqs: [
          { question: "What is North Carolina's income tax rate for 2025?", answer: "North Carolina has a flat income tax rate of 4.75% for 2024. The rate is scheduled to decrease to 3.99% by 2027 under current law. The standard deduction is $12,750 for single filers and $25,500 for married filing jointly." },
    ...
    washington: {
      "salary-calculator": {
        ...
        faqs: [
          { question: "What is Washington's minimum wage in 2025?", answer: "Washington's minimum wage is $16.28 per hour as of January 2024, adjusted annually for inflation. Seattle's minimum wage is higher at $19.97 per hour for large employers (500+ employees) and $17.25 for smaller employers with health benefits." },
          ...
          { question: "What is the Seattle minimum wage for 2025?", answer: "Seattle's minimum wage is $19.97 per hour for large employers with 500+ employees. For smaller employers with 500 or fewer employees, the rate is $17.25 if they pay at least $2.19 per hour toward health benefits, or $19.97 if they do not." },
        ],
      },
      "tax-calculator": {
